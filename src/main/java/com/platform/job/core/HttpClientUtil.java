...
public class HttpClientUtil {
	...
	public static String doInPost(String url, String json) {
		// 创建Httpclient对象
		CloseableHttpClient httpClient = HttpClients.createDefault();
		CloseableHttpResponse response = null;
		InputStream in = null;
	...
	public static Map<String, String> getParams(String url) {
		//String url="https://wxpt.91steel.com/a/s/v?path=https://wxpt.91steel.com/mtcplat/mobile/images/android-qr.png&a=b";
		String param=url.split("[?]")[1];
		String[] paramSplit = param.split("[&]");
		Map<String, String> mapRequest = new HashMap<String, String>();
		for(String p:paramSplit) {
			String[] s=p.split("[=]");
			mapRequest.put(s[0], s[1]);
		}
		return mapRequest;
	}
